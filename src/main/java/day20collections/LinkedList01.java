...
public class LinkedList01 {
    ...
    public static void main(String[] args) {
      ...
      /*
      1)Arraylistler eleman silme ve elaman eklemede başarısızdırlar.
      O yüzden elelman silme ve ekleme işlemleri çoklukla yapılacaksa Arraylist kullanmak tavsiye edilmez.
