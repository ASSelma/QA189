...
/*
1) Iterators lar loop ların yaptığı aynı işi yapar
2) Iterators larda sonsuz loop oluşma ihtimali yoktur
3) Iterators lar ile looplar arasında performans farkı yoktur
4) Iterators lar bir collection eleman silme ve bir coollection daki elemanı değiştirme konusunda daha başarılıdır
5)İki tip Iterators vardır;
    a) Iterators:
