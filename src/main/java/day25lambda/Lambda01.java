...
public class Lambda01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        printSumOfSguaresOfDistinctElemnet(nums);

        printProductOfSquareDistinctEvenElements(nums);
        getMaxValue1(nums);
        getMinValue1(nums);
    }
...
public static void  printSumOfSguaresOfDistinctElemnet(List<Integer>nums){
    ...
    public static void printProductOfSquareDistinctEvenElements(List<Integer>nums){
